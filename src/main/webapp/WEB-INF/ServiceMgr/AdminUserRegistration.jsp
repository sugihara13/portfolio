    	...
    	<main class="vertical-flexbox">
    		<div class="container vertical-flexbox">
    			...
    			<div class="form-wrapper">
    				<form id="user-registration" class="registration-form" action="AdminUserRegistration" method="POST">
						...
						<button class="button button-style-blue" type="submit">Registration</button>
					</form>
				</div>
